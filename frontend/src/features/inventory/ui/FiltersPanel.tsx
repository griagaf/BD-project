...
export function FiltersPanel({ filters, categories = [], types = [], onChange }: FiltersPanelProps) {
  ...
  return (
    <Card className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_180px_180px_auto]">
      ...
      <select
        ...
        className="h-10 min-w-0 rounded-md border border-zinc-800 bg-zinc-950 px-3 text-sm text-zinc-100 outline-none focus:border-emerald-500"
      >
